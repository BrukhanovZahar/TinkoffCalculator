...
//  TinkoffCalculator
//
//  Created by Захар Брюханов on 21.02.2024.
//
...
extension CalculationHistoryItem: Codable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        switch self {
            case.number(let value): try container.encode(value, forKey: CodingKeys.number)
            case .operation(let value): try container.encode(value.rawValue, forKey: CodingKeys.operation)
        }
    }
